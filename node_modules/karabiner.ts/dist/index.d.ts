export declare const accessibilityVariable: {
    readonly roleString: "accessibility.focused_ui_element.role_string";
    readonly subroleString: "accessibility.focused_ui_element.subrole_string";
    readonly titleString: "accessibility.focused_ui_element.title_string";
    readonly windowPositionX: "accessibility.focused_ui_element.window_position_x";
    readonly windowPositionY: "accessibility.focused_ui_element.window_position_y";
    readonly windowSizeHeight: "accessibility.focused_ui_element.window_size_height";
    readonly windowSizeWidth: "accessibility.focused_ui_element.window_size_width";
};
...
export declare class BasicManipulatorBuilder implements ManipulatorBuilder {
    ...
    /** To { generic_desktop } */
    toGenericDesktop(code: number, modifiers?: ModifierParam, options?: ToEventOptions): this;
    /** Map to mouse button */
    ...
    toVarExpression(name: string, options: {
        expression: string;
    ...
    toIfOtherKeyPressed(otherKeys: (FromKeyType & {
        modifiers?: FromModifiers;
    })[], to: ToEvent | ToEvent[]): this;
    /** Map to to_if_other_key_pressed */
    toIfOtherKeyPressed(otherKeys: (FromKeyType & {
        modifiers?: FromModifiers;
    })[], key: ToKeyParam, modifiers?: ModifierParam, options?: ToEventOptions): this;
...
export declare let defaultComplexModificationsParameters: ComplexModificationsParameters;

export declare let defaultDoubleTapParameters: {
    'double_tap.delay_milliseconds': number;
};

export declare let defaultDuoLayerParameters: {
    'duo_layer.threshold_milliseconds': number;
    'duo_layer.notification': boolean | string;
    'duo_layer.delay_by_default': boolean;
    'duo_layer.delay_milliseconds': number;
};

export declare let defaultLayerParameters: {
    'layer.delay_by_default': boolean;
    'layer.delay_milliseconds': number;
};

export declare let defaultSimlayerParameters: {
...
export declare type ExpressionCondition = Extract<Condition, {
    type: 'expression_if' | 'expression_unless';
}>;
...
export declare function unlessApp(bundleId: string | RegExp | Array<string | RegExp>, description?: string): ConditionBuilder;

export declare function unlessApp(app: {
    file_paths?: Array<string | RegExp>;
    bundle_identifiers?: Array<string | RegExp>;
    description?: string;
}): ConditionBuilder;
...
export declare function ifExpression(expression: string, description?: string): ConditionBuilder;
...
export declare let internationalKeyCodes: readonly ["international1", "international3", "lang1", "lang2"];
...
export declare let japaneseKeyCodes: readonly ["japanese_eisuu", "japanese_kana"];
...
export declare interface ManipulatorBuilder {
...
export declare type ModificationParameters = ComplexModificationsParameters & Partial<typeof defaultDoubleTapParameters> & Partial<typeof defaultLayerParameters> & Partial<typeof defaultSimlayerParameters> & Partial<typeof defaultDuoLayerParameters>;
...
export declare let modifierKeyCodes: readonly ["left_control", "left_shift", "left_option", "left_command", "right_control", "right_shift", "right_option", "right_command", "fn", "caps_lock"];
...
export declare let multiModifierAliases: {
    readonly Meh: ["option", "control", "shift"];
    readonly Hyper: ["command", "option", "control", "shift"];
    readonly SuperHyper: ["command", "option", "control", "shift", "fn"];
    readonly '\u2318\u21E7': ["command", "shift"];
    readonly '\u2325\u21E7': ["option", "shift"];
    readonly '\u2303\u21E7': ["control", "shift"];
    readonly '\u2318\u2325': ["command", "option"];
    readonly '\u2318\u2303': ["command", "control"];
    readonly '\u2325\u2303': ["option", "control"];
    readonly '\u2318\u2325\u2303': ["command", "option", "control"];
    readonly '\u2318\u2325\u21E7': ["command", "option", "shift"];
    readonly '\u2318\u2303\u21E7': ["command", "control", "shift"];
    readonly '\u2325\u2303\u21E7': ["option", "control", "shift"];
    readonly '\u2318\u2325\u2303\u21E7': ["command", "option", "control", "shift"];
};

export declare type NamedMultiModifierAlias = keyof typeof namedMultiModifierAliases;

export declare let namedMultiModifierAliases: {
    readonly Meh: ["option", "control", "shift"];
    readonly Hyper: ["command", "option", "control", "shift"];
    readonly SuperHyper: ["command", "option", "control", "shift", "fn"];
};
...
declare let optionalAnyAliases: readonly ["optionalAny", "?any", "??"];
...
export declare type SimpleManipulator = Pick<BasicManipulator, 'from' | 'to'>;
 ...
 */
export declare function simpleModifications(manipulatorSources: Array<Manipulator | ManipulatorBuilder | ManipulatorMap>): SimpleManipulator[];
...
export declare let systemSounds: readonly ["Tink", "Submarine", "Sosumi", "Morse", "Ping", "Pop", "Purr", "Glass", "Hero", "Frog", "Funk", "Blow", "Bottle", "Basso"];
...
export declare type ToFromEvent = Extract<ToEvent, {
    from_event: boolean;
}>;

/** Create ToEvent with from_event */
export declare function toFromEvent(): ToEvent;

/** Create ToEvent with generic_desktop code */
export declare function toGenericDesktop(code: number, modifiers?: ModifierParam, options?: ToEventOptions): ToEvent;

/** Create ToEvent with key_code ⌘⌥⌃⇧ */
export declare function toHyper(options?: ToEventOptions): ToEvent;

/** @see https://karabiner-elements.pqrs.org/docs/json/complex-modifications-manipulator-definition/to-if-other-key-pressed/ */
export declare type ToIfOtherKeyPressed = {
...
export declare type ToSendUserCommand = {
    endpoint?: string;
    payload: unknown;
};

/** Create ToEvent with send_user_command */
export declare function toSendUserCommand(payload: unknown, endpoint?: string): ToEvent;

export declare type ToSendUserCommandEvent = Extract<ToEvent, {
    send_user_command: ToSendUserCommand;
}>;
...
export declare function toSetVarExpression(name: string, options: {
    expression: string;
    key_up_expression?: string;
}): ToEvent;
...
export declare function writeToGlobal(global: KarabinerConfig['global'], karabinerJsonPath?: string): void;
 ...
 */
export declare function writeToProfile(writeTarget: '--dry-run' | string | WriteTarget, rules: Array<Rule | RuleBuilder>, parameters?: ModificationParameters, extras?: {
    simple_modifications?: Array<Manipulator | ManipulatorBuilder | ManipulatorMap>;
}): void;
