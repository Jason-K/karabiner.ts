...
export declare let controlOrSymbolKeyAliases: {
    ...
    readonly '{': "open_curly_bracket";
    readonly '}': "close_curly_bracket";
    readonly '\\': "backslash";
    readonly ';': "semicolon";
    readonly "'": "quote";
