...
export declare class BasicManipulatorBuilder implements ManipulatorBuilder {
    ...
    /** To Super key ⌘⌥⌃⇧ */
    toSuper(options?: ToEventOptions): this;
...
export declare let multiModifierAliases: {
    readonly Meh: ["command" , "option", "shift"];
    readonly Hyper: ["command", "option", "control"];
    readonly Super: ["command", "option", "control", "shift"];
...
export declare function toSuper(options?: ToEventOptions): ToEvent;
