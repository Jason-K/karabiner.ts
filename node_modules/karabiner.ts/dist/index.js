let x = [
  ...
  "lang1",
  "lang2"
], $e = ["japanese_eisuu", "japanese_kana"], De = [
  "volume_down",
...
function A(t) {
  if (!t) return;
  if (typeof t == "string")
    return X(t) ? te(t) : t in q ? [q[t]] : t in ae ? ae[t] : [t];
  if (Array.isArray(t))
    return Le(t) ? Be(t) : t.map(Ie);
  let e;
  "left" in t ? e = j("left", t.left) : "l" in t && (e = j("left", t.l));
  let i;
  if ("right" in t ? i = j("right", t.right) : "r" in t && (i = j("right", t.r)), !(!(e != null && e.length) && !(i != null && i.length)))
    return [...e || [], ...i || []];
}
...
function Vt(t, e) {
  ...
  if (Array.isArray(t))
    ...
    return new M({
      ...
      bundle_identifiers: (r = t.bundle_identifiers) == null ? void 0 : r.map(z)
    });
  return new M({
    type: "frontmost_application_if",
    description: e,
...
function k(t, e) {
  ...
  return typeof t == "object" && "optional" in t ? I("", t.optional) : I(t, e);
}
function R(t, e, i) {
  if (typeof t == "object")
    return new V(t);
...
class V {
  ...
  toRemoveNotificationMessage(e) {
    return this.addToEvent(F(e)), this;
  }
...
function Ut(...t) {
  return (e) => {
    ...
    let n = (Array.isArray(e) ? e : O(e)).reduce(
      (s, u) => [...s, ...O(u).map(o)],
      []
    );
...
function zt(t, e) {
  return (i) => ({
    build: (o) => {
      ...
      return (Array.isArray(i) ? i : O(i)).map((s) => O(s, o)).reduce((s, u) => s.concat(u), []).map((s) => {
        var l;
        let u = Object.keys(r).reduce(
          (d, _) => {
            var h;
            if (!((h = r[_]) != null && h.length)) return d;
...
function ct(t, e, i) {
  let o = (n) => S(n, H, "for from.simultaneous"), r = new pt({
    simultaneous: t.map(
...
class mt extends V {
  ...
  build(e) {
    ...
    let n = this.singleTapEvent && "key_code" in this.singleTapEvent ? x.includes(this.singleTapEvent.key_code) : !1, s = ["double-tap", r];
    ...
    let u = s.join("-"), l = g(u).build(), d = g(u).unless().build(), _ = ht({
      ...this.manipulator,
      conditions: [l]
    }), f = {
      ...this.manipulator,
    ...
    return n && !((p = f.to_if_held_down) != null && p.length) && (f.to_if_held_down = [this.singleTapEvent]), f.parameters = {
...
function Qt(t, e, i = 1, o = 0) {
  return wt("Hyper", t, e, i, o);
}
let W = "__layer", de = "__delay";
class vt extends Z {
  ...
  leaderMode(e = !0) {
    return typeof e == "boolean" ? this.leaderModeOptions = e ? G : void 0 : this.leaderModeOptions = { ...G, ...e }, this;
  }
  ...
  build(e) {
    ...
    if (this.leaderModeOptions) {
      ...
      this.layerNotification && l.push(F(we(this.varName))), this.leaderModeOptions.sticky || i.manipulators.forEach(
    ...
    if ((n = (r = this.layerModifiers) == null ? void 0 : r.mandatory) != null && n.length || (u = (s = this.layerModifiers) == null ? void 0 : s.optional) != null && u.length) {
...
function ke(t, e, i, o, r, n, s, u, l, d, _, f) {
  var B;
  function h(y) {
    var re;
    if (!u) return y;
    let D = u.build()[0], K = v(y)[0];
    if ([
      "to",
      "to_if_alone",
      "to_if_held_down",
      ...
      (C) => {
        var U;
        return (U = D[C]) == null ? void 0 : U.forEach(
          (J) => K[C] = [...K[C] || [], J]
        );
      }
    ), D.to_delayed_action) {
      ...
      for (let C of ["to_if_invoked", "to_if_canceled"])
        D.to_delayed_action[C].forEach(
          (U) => {
            var J;
            return (J = K.to_delayed_action) == null ? void 0 : J[C].push(U);
          }
        );
    }
  ...
  let p = Mt(f, s), a = R({ key_code: t, modifiers: r }).toVar(e, p > 0 ? de : i).toVar(W).condition(
    p > 0 ? g(e, o) : g(e, i).unless(),
    g(W).unless()
  );
  !((B = r == null ? void 0 : r.mandatory) != null && B.length) && !_ && a.toIfAlone({ key_code: t }), _ || a.toAfterKeyUp(c(e, o)).toAfterKeyUp(c(W, 0));
  let m = g(e, de).build();
  ...
  }), n != null && n.length && a.condition(...n), d) {
    let y = we(e);
    p > 0 ? (a.toIfHeldDown(ie(y, d)), a.toDelayedAction([], {
      ...F(y),
      conditions: [m]
    })) : a.toNotificationMessage(y, d), _ || a.toAfterKeyUp(F(y));
  }
  if (!s)
    return h(a.build());
  let T = [
...
class Ct extends Z {
  ...
  build(e) {
    let i = super.build(e), o = (e == null ? void 0 : e.getParameters(fe)) ?? fe, r = this.threshold || o["simlayer.threshold_milliseconds"], n = this.conditions.length > 1 ? this.conditions.filter((l) => l != this.layerCondition).map($) : void 0, s = c(this.varName, this.onValue), u = c(this.varName, this.offValue);
...
class Et extends Z {
  ...
  build(e) {
    ...
    let f = [
      ...
      return u.length && m.condition(...u), s > 0 ? m.toIfHeldDown(l).toIfAlone(a.map((T) => b(T))).parameters({
    ...
    if (p)
      p.forEach((a) => {
        ...
        )) || ((w = a.to) == null || w.push(c(this.varName, this.onValue)), (B = (L = a.from.simultaneous_options) == null ? void 0 : L.to_after_key_up) == null || B.push(
          c(this.varName, this.offValue)
        ));
      });
    else {
      let a = f.flatMap((m) => m.build(e));
...
function Zt(t, e, i = {}, o) {
  ...
  let { name: r, dryRun: n } = t, s = t.karabinerJsonPath ?? E.karabinerConfigFile(), u = n ? { profiles: [{ name: r, complex_modifications: { rules: [] } }] } : E.readKarabinerConfig(s), l = u == null ? void 0 : u.profiles.find((_) => _.name == r);
  l || N(`⚠️ Profile ${r} not found in ${s}.
...
ℹ️ Please check the profile name in the Karabiner-Elements UI and 
 ...
 `);
  try {
    l.complex_modifications = Kt(e, i);
  } catch (_) {
    N(_);
  }
  if (o != null && o.simple_modifications)
    try {
      l.simple_modifications = St(
  ...
  E.writeKarabinerConfig(d, s).catch(N), console.log(`✓ Profile ${r} updated.`);
}
function N(t) {
...
function ei(t, e) {
  ...
  E.writeKarabinerConfig(r, i).catch(N), console.log("✓ global updated.");
}
function ti(t) {
  return {
    build() {
...
export {
  V as BasicManipulatorBuilder,
  M as ConditionBuilder,
  pe as arrowKeyAliases,
  Ce as arrowKeyCodes,
  $ as buildCondition,
  Kt as complexModifications,
  he as controlOrSymbolKeyAliases,
  ...
  Vt as ifApp,
  Lt as ifDevice,
  Bt as ifDeviceExists,
  qt as ifEventChanged,
  Nt as ifInputSource,
  ...
  jt as toOnlyConsumerKeyCodes,
  H as toOnlyKeyCodes,
  Ze as toPaste,
  Ht as toPlaySound,
  Xe as toPointingButton,
  F as toRemoveNotificationMessage,
  c as toSetVar,
  st as toSleepSystem,
