...
const tapHoldKeys: Record<string, TapHoldConfig> = {
  ...
  h: {      description: 'HS console / Skim heading',     hold: [cmd("/opt/homebrew/bin/hs -c 'hs.openConsole()'")],
            appOverrides: [ {
                app: /^net\.sourceforge\.skim-app\.skim$/,
...
const spaceLayers: SubLayerConfig[] = [
  {
    ...
    mappings: {
      ...
      c: { description: 'Code',         openAppOpts: { bundleIdentifier: 'com.microsoft.VSCodeInsiders' } },
      d: { description: 'Dia',          openAppOpts: { bundleIdentifier: 'company.thebrowser.dia' } },
      f: { description: 'QSpace',       openAppOpts: { bundleIdentifier: 'com.jinghaoshe.qspace.pro' } },
      ...
      o: { description: 'Outlook',      openAppOpts: { bundleIdentifier: 'com.microsoft.Outlook' } },
      p: { description: 'Proton Mail',  openAppOpts: { bundleIdentifier: 'ch.protonmail.desktop' } },
      q: { description: 'QSpace',       openAppOpts: { bundleIdentifier: 'com.jinghaoshe.qspace.pro' } },
      s: { description: 'Safari',       openAppOpts: { bundleIdentifier: 'com.apple.Safari' } },
      t: { description: 'Teams',        openAppOpts: { bundleIdentifier: 'com.microsoft.teams2' } },
      v: { description: 'Code',         openAppOpts: { bundleIdentifier: 'com.microsoft.VSCodeInsiders' } },
      w: { description: 'Word',         openAppOpts: { bundleIdentifier: 'com.microsoft.Word' } },
      tab: { description: 'Last App',   openAppOpts: { historyIndex: 1 }, usageCounterVar: 'apps_toggle_uses' },
    },
  },
  {
    layerKey: 'm',
    ...
    mappings: {
      ...
      d:    { description: 'Delete',          key: 'delete_or_backspace',   passModifiers: true },
      f:    { description: 'Forward Delete',  key: 'delete_forward',        passModifiers: true },
  ...
  },
  {
    ...
    mappings: {
      ...
      o:    { description: 'My OneDrive',     command: 'open -b com.jinghaoshe.qspace.pro /Users/jason/Library/CloudStorage/OneDrive-Personal' },
