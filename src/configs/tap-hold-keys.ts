...
export const tapHoldKeys: Record<string, TapHoldConfig> = {
  ...
  g: {
    description: "Claude",
    hold: [cmd(openAppBundleCommand("com.anthropic.claudefordesktop"))],
  },
  h: {
    description: "Here2There",
    hold: [cmd(raycastExtensionCommand("Jason/here-to-there/activeToTarget"))],
  },
  j: {
    description: "Last d/l",
    hold: [cmd(raycastExtensionCommand("jason/recents/recentDownloads"))],
  },
  k: {
    description: "Kitty",
  ...
  r: {
    description: "Last d/l",
    hold: [cmd("/Users/jason/Scripts/filesystem/recent_changes/recent_dl.sh")],
  },
  s: {
    description: "Screenshot",
    hold: [cmd(cleanShotCommand("capture-area"))],
  },
  t: {
    description: "Todoist",
    hold: [cmd(openAppBundleCommand("com.todoist.mac.Todoist"))],
  },
  v: {
    description: "Maccy",
    hold: [
  ...
  z: {
    ...
    hold: [
      cmd(
        raycastExtensionCommand("mrpunkin/raycast-zoxide/search-directories"),
      ),
    ],
  },
  "8": {
    description: "RingCentral",
    hold: [cmd(openAppBundleCommand("com.ringcentral.glip"))],
  },
  f1: {
  ...
  "right_option+k": {
    ...
    hold: [cmd(takeActionHereCommand("kitty"))],
    timeoutMs: 300,
    thresholdMs: 300,
  },
  "right_option+s": {
    ...
    alone: [
      cmd(
        `if pgrep -x 'Spotify' > /dev/null; then ${raycastExtensionCommand("mattisssa/spotify-player/togglePlayPause")}; else ${openAppBundleCommand("com.spotify.client")}; fi; echo 'Spotify toggled'`,
      ),
    ],
